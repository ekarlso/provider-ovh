...
func (mg *ProjectGateway) ResolveReferences( // ResolveReferences of this ProjectGateway.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("network.ovh.m.edixos.io", "v1beta1", "PrivateNetwork", "PrivateNetworkList")
		if err != nil {
	...
	{
		m, l, err = apisresolver.GetManagedResource("network.ovh.m.edixos.io", "v1beta1", "Subnet", "SubnetList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
