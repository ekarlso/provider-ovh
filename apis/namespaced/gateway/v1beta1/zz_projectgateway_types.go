...
type ProjectGatewayInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/edixos/provider-ovh/apis/namespaced/network/v1beta1.PrivateNetwork
	NetworkID *string `json:"networkId,omitempty" tf:"network_id,omitempty"`
	...
	// +crossplane:generate:reference:type=github.com/edixos/provider-ovh/apis/namespaced/network/v1beta1.Subnet
	SubnetID *string `json:"subnetId,omitempty" tf:"subnet_id,omitempty"`
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,managed,lb}
