...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,providerconfig,ovh}
...
// +kubebuilder:resource:scope=Cluster,categories={crossplane,providerconfig,ovh}
// +kubebuilder:storageversion
